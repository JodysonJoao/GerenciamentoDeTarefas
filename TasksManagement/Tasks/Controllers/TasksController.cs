...
public class TasksController : ControllerBase
{
    ...
    [HttpPost("create")]
    [Authorize]
    public IActionResult CreateTask([FromBody] TasksManagement.Tasks.Models.Task task)
    {
    ...
    [HttpPut("{id}")]
    [Authorize]
    public IActionResult UpdateTask(int id, TasksManagement.Tasks.Models.Task task)
    {
